    ...
    <section className="mx-auto max-w-content px-4 py-16 text-center sm:px-6 sm:py-24">
      ...
      <div className="mt-12 grid gap-6 text-left sm:grid-cols-2">
        {data.items.map((item, i) => (
          ...
          >
            <figure className="h-full rounded-[40px] border border-brand-100 bg-white p-8 shadow-[0px_5px_10px_rgba(0,0,0,0.05),0px_15px_30px_rgba(0,0,0,0.05),0px_30px_60px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:-translate-y-1.5">
              <Quotes
                size={28}
                weight="fill"
