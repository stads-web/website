    ...
    <section className="mx-auto max-w-content px-4 pb-16 pt-4 sm:px-6 sm:pb-24 sm:pt-6">
      ...
      <div className="mt-12 flex flex-col gap-16 sm:gap-20">
        {data.items.map((item) => (
          ...
          >
            <div className="relative aspect-[478/315] w-full overflow-hidden rounded-[40px] border border-white/60 shadow-[0px_5px_10px_rgba(0,0,0,0.05),0px_15px_30px_rgba(0,0,0,0.05),0px_30px_60px_rgba(0,0,0,0.1)]">
              <Image
                src={item.image}
                alt={item.imageAlt}
                fill
