  ...
  return (
    <section className="py-20 text-center sm:py-28">
      <div className="mx-auto max-w-content px-4 sm:px-6">
        ...
        <Link
          href={data.ctaHref}
          className="mt-8 inline-flex items-center gap-3 rounded-lg border border-brand-800 bg-brand-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-600"
        >
          {data.ctaLabel}
